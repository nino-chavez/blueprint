...
Shared React component library for the blueprint-platform family. Patterns adapted from the commerce platform's `storefront-kit` (React + Tailwind + Radix + CVA), tuned for our portfolio: portal, prototype, storefront-catalyst, subscriber portal, admin.
