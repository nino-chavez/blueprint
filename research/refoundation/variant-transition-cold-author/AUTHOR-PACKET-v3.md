# Variant-transition cold-author packet — v3
...
`methodology_creator_interventions` (`0` means none). Record every attempt,
...
invocation with the exact `command`, operation (`plan` or `apply`), integer
