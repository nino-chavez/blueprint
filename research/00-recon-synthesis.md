...
- **Multi-operator attribution loss** — operators sharing one `.git/` lose authorship (`docs/patterns/multi-operator-collab-pattern.md`).
...
- Evidence: `tools/blueprint/docs/case-study-{v3-portal-css-gap,subs-initiative-skipped-stages-2-4,pp-cx}.md`, `docs/patterns/multi-operator-collab-pattern.md`.
