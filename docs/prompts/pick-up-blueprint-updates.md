...
```
Blueprint was renamed from the original employer-prefixed name on 2026-05-25. New location:
...
6. Sweep this initiative for stale references: `big-blueprint` → `blueprint`,
   `the original employer-prefixed name` → `Blueprint`, github.com/nino-chavez/big-blueprint →
