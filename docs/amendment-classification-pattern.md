...
| **template** | The methodology's template files (the substrate consumers stamp from) need updating | `template/` in the methodology source repo | Wave 17's bc-promo-rules scaffold contamination — `stamp.mjs` + reviewer banner enforcement |
