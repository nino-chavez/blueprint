...
Every B2B flow must name *which actor* (per `wip/bc-subscriptions/docs/decisions/0023-multi-actor-roles.md`):
...
- `~/Workspace/dev/wip/bc-subscriptions/docs/decisions/0023-multi-actor-roles.md` — actor pattern source
