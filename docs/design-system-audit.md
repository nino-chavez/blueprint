# Design System Audit — required coverage for BigBlueprint initiatives
...
- Not a component-library-from-scratch mandate. Custom-design-system initiatives ship the primitives; existing-design-system initiatives (BigDesign, Radix Themes, shadcn) inherit and only define what's specific.
