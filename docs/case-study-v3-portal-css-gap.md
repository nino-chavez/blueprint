...
- Sibling case studies: `docs/case-study-bc-subscriptions-skipped-stages-2-4.md`, `docs/case-study-pp-cx.md`
...
### What this means for the bc-subscriptions / rally-hq / v3 consumers
...
- **bc-subscriptions** (Pattern A): no migration yet. Pattern A canonical chrome surface needs an audit before the manifest can be declared. Tracked.
