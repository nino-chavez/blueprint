...
**Source:** `subs-initiative` and a B2B client engagement initiative (May 2026).
...
subs-initiative has 8 workflows; paradigm-b2b mirrors with project-specific names:
...
**Use when:** Initiative is small, single-team, hackathon-style. subs-initiative uses this shape.
...
| Source | Path / URL |
|---|---|
| subs-initiative wrangler configs | `~/Workspace/dev/wip/subs-initiative/{infra/cloudflare,apps/*/}wrangler.toml` |
| subs-initiative GitHub Actions | `~/Workspace/dev/wip/subs-initiative/.github/workflows/` |
