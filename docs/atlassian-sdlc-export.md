...
github_issue: https://github.com/nino-chavez/bc-subscriptions/issues/685
sources:
...
> for what to adapt. This doc is the **`bc-subscriptions` reference case study**
> ([#685](https://github.com/nino-chavez/bc-subscriptions/issues/685)), proven
...
> counts are bc-subscriptions-specific.
...
## Test management: Xray is the BigCommerce standard (grounded)
