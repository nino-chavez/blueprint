...
**Activates when**: any BigBlueprint initiative needs the agent to validate its own UI work — i.e., every initiative with a `prototype/` or `portal/` shell.
