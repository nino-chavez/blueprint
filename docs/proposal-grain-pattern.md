...
## Implementation companion in bc-subscriptions

- [`WAYS-OF-WORKING.md` — Proposal taxonomy, Proposal grain rule section](https://github.com/nino-chavez/bc-subscriptions/blob/main/WAYS-OF-WORKING.md#proposal-grain-rule-hive-1371-ratified-2026-05-20) — the per-project codification.
