# Case Study — subs-initiative: What Happens When Stages 2 and 4 Get Skipped
...
which the subs-initiative retrofit Decision now codifies, see
`feature/subs-initiative-retrofit-contribution`):
...
## Pattern-level lessons (applicable beyond subs-initiative)
...
subs-initiative's `bc-payments-mit-verified` memory said "BC Payments
...
subs-initiative ran a 5-persona journey-tracing exercise (the A→B→C
...
runtime-complete. That's the gap subs-initiative illustrates.
...
- This contribution: feature/subs-initiative-retrofit-contribution branch on big-blueprint
