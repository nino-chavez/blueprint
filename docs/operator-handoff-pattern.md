...
**Status**: Promoted 2026-05-27 wave 25 from converging consumer evidence (rally-hq + subs-initiative independently producing hand-written HANDOFF docs with overlapping structure).
...
| Section | Purpose | rally-hq example | subs-initiative example |
|---|---|---|---|
...
| What's done | Completed work the next operator can build on | (implicit — gaps already analyzed at consumer side) | Checklist: `[x] git subtree add of <owner>/ai-hive...` |
