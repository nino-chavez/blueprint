...
The stamper handles project name, repo URL, tagline, package scope, `--bcs-*` CSS prefix, and logo substitution. Post-stamp mechanical check fails on any unexpected residual `bc-subscriptions` strings.
