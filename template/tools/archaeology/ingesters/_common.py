...
PROJECT_ID = os.environ.get("ARCHAEOLOGY_PROJECT_ID", "{{PROJECT_ID}}")
WORKER_URL = os.environ.get("ARCHAEOLOGY_WORKER_URL", "https://{{PROJECT_SLUG}}-archaeology.{{CF_WORKERS_SUBDOMAIN}}.workers.dev")
