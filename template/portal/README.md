...
The canonical big-blueprint portal shell as of 2026-05-23. Static HTML + Cloudflare Pages Functions. Replaces the React/the platform design system prototype model for non-BC projects.

## When to use this

- New big-blueprint initiative that isn't BC/the platform design system-bound
