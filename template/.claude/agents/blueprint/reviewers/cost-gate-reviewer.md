...
This reviewer enforces the anchors and the gate rule codified in [`ADR-0003-cost-effort-dial.md`](../../../../../docs/decisions) and the calibration discipline in [`docs/tiered-orchestration-pattern.md`](../../../../../docs/tiered-orchestration-pattern.md).
