...
Prototype phase of a the original employer-prefixed name initiative. Three target paradigms; pick by reading `blueprint.yml prototype.host` + `prototype.design_system`.
