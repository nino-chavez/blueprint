...
If `blueprint.yml prototype.design_system: custom`, all gates are mandatory. If targeting an existing design system, the host's primitives provide some gates (e.g., BigDesign's component a11y) — gate output still must be exit 0.
