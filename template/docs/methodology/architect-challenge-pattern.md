...
The pattern was named from the bc-promo-rules initiative, where comparing "typed condition DSL" vs. "CEL expression engine" required asking questions none of the standard matrices prompted — specifically: what can a merchant author *express* in each option, and what can the platform *validate* in each?
