...
## promo-initiative — Blueprint pipeline dogfood (2026-05-26)
...
- Design coverage: 6 gaps including missing the platform design system DOM vocab (`bd-accordion`, `bd-form-group`, `bd-input`, `bd-button-group`), missing `data-audience-switcher` attribute, fabricated sprint estimates. Fix each in the portal before advancing.
