...
- **Tool rename:** the content-generation tool was renamed to **Forge Signal** everywhere in prose (its prior name had the words reversed). The `signal_forge:` blueprint.yml key is unchanged (compatibility).
